...
class Patient():
    ...
    def bamToFastq(self, cancerBam, cancerFastqR1, cancerFastqR2, normalBam, normalFastqR1, normalFastqR2, dependencies=[]):
        self.writeJob("tofastq_cancer", "150:00:00", "12", "java -jar /srv/gsfs0/software/picard-tools/1.92/SamToFastq.jar INPUT=$1 FASTQ=$2 SECOND_END_FASTQ=$3", 
                      [cancerBam, cancerFastqR1, cancerFastqR2], dependencies=dependencies)
        self.writeJob("tofastq_normal", "150:00:00", "12", "java -jar /srv/gsfs0/software/picard-tools/1.92/SamToFastq.jar INPUT=$1 FASTQ=$2 SECOND_END_FASTQ=$3", 
